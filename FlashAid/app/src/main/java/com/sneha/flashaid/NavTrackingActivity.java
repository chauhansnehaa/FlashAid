...
public class NavTrackingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (driverId == null) {
            Toast.makeText(this, "Diver not logged in!", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
                        ...
                        for (DataSnapshot trackSnap : snapshot.getChildren()) {
                            ...
                            if ("active".equalsIgnoreCase(status)) {
                                ...
                                if (requestId != null && patientLat != null && patientLon != null) {
                                    // ✅ Launch LiveTrackingActivity
                                    Intent intent = new Intent(NavTrackingActivity.this, LiveTrackingActivity.class);
                                    ...
                                    Toast.makeText(NavTrackingActivity.this, "Invalid tracking data", Toast.LENGTH_SHORT).show();
                                }
